...
# This function counts the number of upper case and lower case letter of a given string.
...
# Encrypt and decrypt a txt file (infile) based on the key and option. Output the encrypted
# string to a different txt file (outfile) and print "Wrong file or file path"
# if infile is not found. 
...
# a column (as specified by col_index) in a txt file (infile). 
